          ...
          <div className="relative mx-auto max-w-md">
            ...
            <div className="relative aspect-[3/4] overflow-hidden rounded-3xl shadow-luxe">
              ...
              <img
                ...
                alt="Velvet Bloom event decorator arranging a luxury balloon garland"
                className="h-full w-full object-cover"
                onError={(e) => {
                  (e.target as HTMLImageElement).src =
                    'data:image/svg+xml;utf8,' +
                    encodeURIComponent(
                      '<svg xmlns="http://www.w3.org/2000/svg" width="600" height="800"><rect width="600" height="800" fill="#0B3D2E"/><text x="50%" y="50%" fill="#F7F1E8" font-family="serif" font-size="28" text-anchor="middle">Velvet Bloom</text></svg>'
                    );
                }}
              />
            </div>
