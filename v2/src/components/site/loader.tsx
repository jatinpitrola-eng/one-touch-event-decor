...
/* ----------------------------------------------------------------
   Logo mark — olive branch + arc (recreated to match brand)
----------------------------------------------------------------- */
function LogoMark({ className = '' }: { className?: string }) {
  return (
    ...
    >
      {/* arch */}
      <motion.path
        d="M30 95 C 30 30, 170 30, 170 95"
        stroke="currentColor"
        strokeWidth="1.4"
        fill="none"
      ...
      >
        ...
        {[0, 1, 2].map((i) => (
          <ellipse
            ...
            rx="5.5"
            ry="2.8"
            transform={`rotate(${30 - i * 6} ${40 + i * 1.5} ${58 - i * 9})`}
            fill="currentColor"
            opacity="0.8"
          />
        ))}
      ...
      >
        <line x1="82" y1="112" x2="92" y2="112" stroke="currentColor" strokeWidth="0.8" />
        <circle cx="100" cy="112" r="1.6" fill="currentColor" />
        <line x1="108" y1="112" x2="118" y2="112" stroke="currentColor" strokeWidth="0.8" />
      </motion.g>
    </svg>
  );
}
