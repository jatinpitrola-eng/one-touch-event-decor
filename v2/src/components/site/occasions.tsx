    ...
    >
      ...
      >
        <div className="relative mx-auto max-w-lg">
            ...
            <img
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src =
                  ...
                  encodeURIComponent(
                    `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600"><rect width="800" height="600" fill="#0B3D2E"/><circle cx="400" cy="300" r="120" fill="#D4A5A5" opacity="0.3"/><text x="50%" y="52%" fill="#F7F1E8" font-family="serif" font-size="32" text-anchor="middle">Velvet Bloom</text></svg>`
                  );
              }}
            />
          ...
          >
            <div className="font-script text-2xl leading-none">velvet bloom</div>
